"""
Generates the BOQGen brand assets (icon + horizontal lockup) as PNGs.
...
def draw_horizontal_lockup(
    ...
    """Icon + "BOQGen" wordmark + tagline, on a transparent background.
    ...
    wm_y = int(H * 0.14)
    d.text((text_x, wm_y), "BOQGEN", font=wordmark_font, fill=wordmark_color)

    tagline = "Automated BOQ Generator"
    tag_y = int(H * 0.70)
