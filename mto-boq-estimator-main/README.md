# BOQGen — *From plans to price.* (MVP)
...
The app is styled as **BOQGen** (tagline: *"From plans to price."*). All
...
├── assets/
│   ├── generate_logo.py        # Regenerates the BOQGen logo PNGs (Pillow-only)
...
│   └── theme.py                # BOQGen CSS injection + hero/step-tracker helpers
├── utils/
